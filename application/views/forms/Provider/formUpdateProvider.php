            ...
            <div class="col-md-8">
                ...
                <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" style="width: 50%;" class="form-control" id="nomprov" value="<?php echo $PROVEEDOR->proveedor; ?>" required data-validation-required-message="Ingrese nombre">
