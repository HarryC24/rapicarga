<div class="row">
				<div class="col-md-8">
                <h3>Escriba el Nombre de uno de los Puertos </h3>
                <form data-toggle="validator" role="form" id="searchForm">
	                <div class="control-group form-group">
	                        ...
	                        <div class="form-group">
			    				<button type="button" class="btn btn-primary" onclick="buscarRutasmaestrasCriterio(1);">Buscar Rutas Maestras</button>
			    				<button type="button" class="btn btn-primary" onclick="buscarRutasmaestrasCriterio(2);">&Uacute;ltimos</button>
			  				</div>
